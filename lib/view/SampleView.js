(function(root){
  ...
  */
  var SampleView = UI.app.example.SampleView = Backbone.View.extend({

    // Define the view
    name: 'exampleSampleView',
    description: 'A sample view for the example app',
